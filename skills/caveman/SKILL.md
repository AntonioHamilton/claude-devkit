...
Cópia verbatim de https://github.com/JuliusBrussee/caveman (`skills/caveman/SKILL.md`).
Não editar aqui — para atualizar, puxar do upstream ou usar `npx skills add JuliusBrussee/caveman`.
